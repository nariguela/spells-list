export const spells = [
  ...
  },
  {
    ...
    entries: [
      "Você arremessa uma bolha de ácido. Escolha uma criatura dentro do alcance, ou escolha duas criaturas dentro do alcance que estejam a 1,5 metro uma da outra. Um alvo deve ser bem sucedido num teste de resistência de Destreza ou sofrerá {@dice 1d6} de dano ácido.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "O dano dessa magia aumenta em {@dice 1d6} quando você alcança o 5° nível ({@dice 2d6}), 11° nível ({@dice 3d6}) e 17° nível ({@dice 4d6}).",
        ],
      },
    ],
    scalingLevelDice: {
  ...
  },
  {
    ...
    entries: [
      "Você arremessa um cisco de fogo em uma criatura ou objeto dentro do alcance. Faça um ataque à distância com magia contra o alvo. Se atingir, o alvo sofre {@dice 1d10} de dano de fogo. Um objeto inflamável atingido por essa magia, incendeia se não estiver sendo vestido ou carregado.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "O dano dessa magia aumenta em {@dice 1d10} quando você alcança o 5° nível ({@dice 2d10}), 11° nível ({@dice 3d10}) e 17° nível ({@dice 4d10}).",
        ],
      },
    ],
    scalingLevelDice: {
  ...
  },
  {
    ...
    entries: [
      "Um raio frigido de luz azul clara parte em direção de uma criatura, dentro do alcance. Realize um ataque à distância com magia contra o alvo. Se atingir, ele sofre {@dice 1d8} de dano de frio e seu deslocamento é reduzido em 3 metros até o começo do seu próximo turno.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "O dano da magia aumenta em {@dice 1d8} quando você alcança o 5° nível ({@dice 2d8}), 11° nível ({@dice 3d8}) e 17° nível ({@dice 4d8}).",
        ],
      },
    ],
    scalingLevelDice: {
  ...
  },
  {
    ...
    entries: [
      "Você ergue sua mão em direção de uma criatura que você possa ver, dentro do alcance e projeta um sopro de gás tóxico da sua palma. A criatura deve ser bem sucedida num teste de resistência de Constituição ou sofrerá {@dice 1d12} de dano de veneno.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "O dano dessa magia aumenta em {@dice 1d12} quando você alcança o 5° nível ({@dice 2d12}), 11° nível ({@dice 3d12}) e 17° nível ({@dice 4d12}).",
        ],
      },
    ],
    scalingLevelDice: {
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "O dano dessa magia aumenta em {@dice 1d8} quando você alcança o 5° nível ({@dice 2d8}), 11° nível ({@dice 3d8}) e 17° nível ({@dice 4d8}).",
        ],
      },
    ],
    scalingLevelDice: {
  ...
  },
  {
    ...
    entries: [
      "Um feixe de energia crepitante vai em direção a uma criatura dentro do alcance. Realize uma jogada de ataque à distância com magia contra o alvo. Se atingir, o alvo sofre {@dice 1d10} de dano de energia.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    entries: [
      "Você toca uma criatura voluntária. Uma vez, antes da magia acabar, o alvo pode rolar um {@dice d4} e adicionar o número rolado a um teste de habilidade a escolha dele. Ele pode rolar o dado antes ou depois de realizar o teste de habilidade. Após isso, a magia termina.",
    ],
    areaTags: ["ST"],
    classes: {
      fromClassList: [
  ...
  },
  {
    ...
    entries: [
      ...
      "Você pode, também, atacar com a chama, no entanto, fazer isso acaba com a magia. Quando você conjura essa magia ou com uma ação em um turno posterior, você pode arremessar a chama numa criatura a até 9 metros de você. Faça um ataque à distância com magia. Se atingir, o alvo sofre {@dice 1d8} de dano de fogo.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    entries: [
      "Radiação similar a uma chama desce sobre uma criatura que você possa ver, dentro do alcance. O alvo deve ser bem sucedido num teste de resistência de Destreza ou sofrerá {@dice 1d8} de dano radiante. O alvo não recebe qualquer benefício de cobertura contra esse teste de resistência.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    entries: [
      "A madeira de uma clava ou bordão, que você esteja segurando, é imbuída com o poder da natureza. Pela duração, você pode usar sua habilidade de conjuração ao invés da sua Força para as jogadas de ataque e dano corpo-a-corpo usando essa arma, e o dado de dano da arma se torna um {@dice d8}. A arma também se torna mágica, se ela já não for. A magia acaba se você conjura-la novamente ou se você soltar a arma.",
    ],
    classes: {
      fromClassList: [
        {
  ...
  },
  {
    ...
    components: {
      v: true,
      s: true,
      m: "uma muda de uma planta com espinhos",
    },
    duration: [
      {
        type: "instant",
  ...
  },
  {
    ...
    entries: [
      "Você toca uma criatura voluntária. Uma vez, antes da magia acabar, o alvo pode rolar um {@dice d4} e adicionar o valor jogado a um teste de resistência de sua escolha. Ele pode rolar o dado antes ou depois de realizar o teste de resistência. Então, a magia termina.",
    ],
    areaTags: ["ST"],
    classes: {
      fromClassList: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "água benta ou pó de prata e ferro, consumidos pela magia",
        consumed: true,
      },
    },
    duration: [
    ...
    time: [
      {
        ...
        unit: "reaction",
        condition:
          "que você faz quando é atingido por um ataque ou alvo da magia mísseis mágicos",
      },
    ],
    range: {
      type: "point",
  ...
  },
  {
    ...
    entries: [
      ...
      "Enquanto estiver impedido pela magia, um alvo sofre {@dice 1d6} de dano perfurante no início de cada um dos turnos dele. Uma criatura impedida pelas vinhas ou uma que possa tocar a criatura, pode usar sua ação para realizar um teste de Força contra a CD da magia. Num sucesso, o alvo é libertado.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 2° nível ou superior, o dano aumenta em {@dice 1d6} para cada nível do espaço acima do 1°.",
        ],
      },
    ],
    damageInflict: ["piercing"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "carvão, incenso e ervas no valor de 10 po, que devem ser consumidos pelo fogo em um braseiro de bronze",
        consumed: true,
        cost: 1000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      "Da próxima vez que você atingir uma criatura com um ataque à distância com arma, antes da magia acabar, essa magia cria uma chuva de espinhos que brota da sua arma à distância ou munição. Além do efeito normal do ataque, o alvo do ataque e cada criatura a até 1,5 metro dele, devem realizar um teste de resistência de Destreza. Uma criatura sofre {@dice 1d10} de dano perfurante se falhar na resistência ou metade desse dano se obtiver sucesso.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, o dano aumenta em {@dice 1d10} para cada nível do espaço acima do 1° (até o máximo de {@dice 6d10}).",
        ],
      },
    ],
    damageInflict: ["piercing"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma perola valendo, no mínimo, 100 po e uma pena de coruja",
        cost: 10000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      "Você abençoa até três criaturas, à sua escolha, dentro do alcance. Sempre que um alvo realizar uma jogada de ataque ou teste de resistência antes da magia acabar, o alvo pode jogar um {@dice d4} e adicionar o valor jogado ao ataque ou teste de resistência.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        type: "entries",
        name: "Deite-se",
        entries: ["O alvo deita-se no chão e então, termina seu turno."],
      },
      {
        type: "entries",
        name: "Parado",
  ...
  },
  {
    ...
    entries: [
      "Você coloca uma maldição em uma criatura que você possa ver, dentro do alcance. Até a magia acabar, você causa {@dice 1d6} de dano necrótico extra no alvo sempre que atingi-lo com um ataque. Além disso, escolha uma habilidade quando você conjurar a magia. O alvo tem desvantagem em testes de habilidade feitos com a habilidade escolhida.",
  ...
  },
  {
    ...
    entries: [
      "Enquanto você mantiver suas mãos com os polegares juntos e os dedos abertos, uma fino leque de chamas emerge das pontas dos seus dedos erguidos. Cada criatura num cone de 4,5 metros deve realizar um teste de resistência de Destreza. Uma criatura sofre {@dice 3d6} de dano de fogo se falhar no teste, ou metade desse dano se obtiver sucesso.",
  ...
  },
  {
    ...
    entries: [
      "Sua oração fortalece você com radiação divina. Até o fim da magia, seus ataques com arma causam {@dice 1d4} de dano radiante extra ao atingirem",
    ],
    damageInflict: ["radiant"],
    classes: {
      fromClassList: [
  ...
  },
  {
    ...
    entries: [
      "Um lampejo de luz se lança em direção de uma criatura, à sua escolha, dentro do alcance. Realize um ataque à distância com magia contra o alvo. Se atingir, o alvo sofre",
      "{@dice 4d6} de dano radiante e, a próxima jogada de ataque contra esse alvo, antes do final do seu próximo turno, terá vantagem, graças a penumbra mística cintilando no alvo, até então.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    entries: [
      "Uma criatura, à sua escolha, que você possa ver dentro do alcance recupera uma quantidade de pontos de vida igual a {@dice 1d4} + seu modificador de habilidade de conjuração. Essa magia não tem efeito em mortos-vivos ou constructos",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, a cura aumenta em {@dice 1d4} para cada nível do espaço acima do 1°.",
        ],
      },
    ],
    miscTags: ["HL", "SGT"],
  ...
  },
  {
    ...
    time: [
      {
        ...
        unit: "reaction",
        condition:
          "que você faz em resposta ao sofre dano de uma criatura a até 18 metros de você e que você possa ver",
      },
    ],
    range: {
      type: "point",
    ...
    entries: [
      "Você aponta seu dedo e a criatura que causou dano a você é, momentaneamente, envolta por chamas infernais. A criatura deve realizar um teste de resistência de Destreza. Ela sofre {@dice 2d10} de dano de fogo se falhar na resistência ou metade desse dano se obtiver sucesso.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, o dano aumenta em {@dice 1d10} para cada nível do espaço acima do 1°.",
        ],
      },
    ],
    damageInflict: ["fire"],
  ...
  },
  {
    ...
    entries: [
      "Você cria três dardos brilhantes de energia mística. Cada dardo atinge uma criatura, à sua escolha, que você possa ver, dentro do alcance. Um dardo causa {@dice 1d4 + 1} de dano de energia ao alvo. Todos os dardos atingem simultaneamente e você pode direciona-los para atingir uma criatura ou várias.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    entries: [
      "Da próxima vez que você atingir uma criatura com um ataque corpo-a-corpo com arma enquanto essa magia durar, sua arma flameja com intensas chamas brancas e o ataque causa {@dice 1d6} de dano de fogo extra ao alvo, fazendo-o incendiar pelas chamas. No início de cada turno dele, até a arma acabar, o alvo deve realizar um teste de resistência de Constituição. Se falhar na resistência, ele sofre {@dice 1d6} de dano de fogo. Se passar na resistência, a magia acaba. Se o alvo ou uma criatura a 1,5 metro dele usar uma ação para apagar as chamas ou se algum outro efeito extinguir as chamas (como submergir o alvo em água), a magia acaba.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, o dano extra inicial causado por esse ataque aumenta em {@dice 1d6} para cada nível do espaço acima do 1°.",
        ],
      },
    ],
    damageInflict: ["fire"],
  ...
  },
  {
    ...
    entries: [
      "Uma onda de força trovejante varre tudo a partir de você. Cada criatura num cubo de 4,5 metros originado em você, deve realizar um teste de resistência de Constituição. Se falhar na resistência, uma criatura sofrerá {@dice 2d8} de dano trovejante e será empurrada 3 metros para longe de você. Se obtive sucesso na resistência, a criatura sofrerá metade desse dano e não será empurrada.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, o dano aumenta em {@dice 1d8} para cada nível acima do 1°.",
        ],
      },
    ],
    damageInflict: ["thunder"],
  ...
  },
  {
    ...
    entries: [
      "Um raio crepitante de energia azul é arremessado em uma criatura dentro do alcance, formando um arco elétrico contínuo entre você e o alvo. Faça um ataque à distância com magia contra a criatura. Se atingir, o alvo sofrerá {@dice 1d12} de dano elétrico e, em cada um dos seus turnos, pela duração, você pode usar sua ação para causar {@dice 1d12} de dano elétrico ao alvo, automaticamente. A magia acaba se você usar sua ação para fazer qualquer outra coisa. A magia também acaba se o alvo estiver fora do alcance da magia ou se você tiver cobertura total para ele.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, o dano inicial aumenta em {@dice 1d12} para cada nível do espaço acima do 1°.",
        ],
      },
    ],
    damageInflict: ["lightning"],
  ...
  },
  {
    ...
    entries: [
      "Um feixe ofuscante de luzes coloridas ordenadas, surge da sua mão. Role {@dice 6d10}; o total é a quantidade de pontos de vida de criaturas que essa magia pode afetar. As criaturas num cone de 4,5 metros, originado de você, são afetadas em ordem ascendente dos seus pontos de vida (ignorando criaturas inconsciente e que não podem ver).",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 2° nível ou superior, jogue {@dice 2d10} adicionais para cada nível do espaço acima do 1°.",
        ],
      },
    ],
    areaTags: ["N"],
  ...
  },
  {
    ...
    components: {
      s: true,
      m: {
        text: "uma tinta à base de chumbo valendo, no mínimo, 10 po, que é consumida pela magia",
        consumed: true,
        cost: 1000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      "Reforçando-se com uma vitalidade necromântica ilusória, você ganha {@dice 1d4 + 4} pontos de vida temporários pela duração.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    entries: [
      "Faça um ataque corpo-a-corpo com magia contra uma criatura dentro do alcance. Se atingir, o alvo sofre {@dice 3d10} de dano necrótico.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, o dano aumenta em {@dice 1d10} para cada nível acima do 1°.",
        ],
      },
    ],
    damageInflict: ["necrotic"],
  ...
  },
  {
    ...
    entries: [
      "Um raio adoecente de energia esverdeada chicoteia na direção de uma criatura dentro do alcance. Faça um ataque à distância com magia contra o alvo. Se atingir, o alvo sofrerá {@dice 2d8} de dano de veneno e deve realizar um teste de resistência de Constituição. Se falhar na resistência, ele também ficará envenenado até o final do seu próximo turno.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, o dano da magia aumenta em {@dice 1d8} para cada nível do espaço acima do 1°.",
        ],
      },
    ],
    damageInflict: ["poison"],
    ...
    time: [
      {
        ...
        unit: "reaction",
        condition:
          "que você realiza quando você ou uma criatura a até 18 metros cair",
      },
    ],
    range: {
      type: "point",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "pó de ouro valendo, no mínimo, 25 po, consumido pela magia",
        consumed: true,
        cost: 2500,
      },
    },
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um par de anéis de platina valendo, no mínimo, 50 po cada, que você e o alvo devem usar pela duração",
        cost: 5000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      "Você preenche o ar com adagas giratórias num cubo de 1,5 metro quadrado, centrado em m ponto, à sua escolha, dentro do alcance. Uma criatura sofre {@dice 4d4} de dano cortante quando entra na área da magia pela primeira vez no turno dela ou começa seu turno na área.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 3° nível ou superior, o dano aumenta em {@dice 2d4} para cada nível do espaço acima do 2°.",
        ],
      },
    ],
  ...
  },
  {
    ...
    components: {
      v: true,
      s: true,
      m: "pouco de seco, uma pitada de enxofre e uma camada de pó de ferro",
    },
    duration: [
      {
        type: "timed",
    ...
    entries: [
      "Uma esfera de fogo, com 1,5 metro de diâmetro, aparece em um espaço desocupado, à sua escolha, dentro do alcance e permanece pela duração. Qualquer criatura que terminar seu turno a até 1,5 metro da esfera, deve realizar um teste de resistência de Destreza. A criatura sofre {@dice 2d6} de dano de fogo se falhar na resistência, ou metade desse dano se obtiver sucesso.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 3° nível ou superior, o dano aumenta em {@dice 1d6} para cada nível do espaço acima do 2°.",
        ],
      },
    ],
    damageInflict: ["fire"],
  ...
  },
  {
    ...
    entries: [
      ...
      "As teias são inflamáveis. Qualquer cubo de 1,5 metro de teia exposto ao fogo, é consumida por ele em 1 rodada, causando {@dice 2d4} de dano de fogo a qualquer criatura que começar seu turno nas chamas.",
    ],
    damageInflict: ["fire"],
    savingThrow: ["dexterity"],
    opposedCheck: ["strength"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "varetas, ossos ou objetos similarmente marcados valendo, no mínimo, 25 po",
        cost: 2500,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      "Da próxima vez que você atingir uma criatura com um ataque com arma, antes do fim da magia, a arma cintilará com radiação astral quando você golpear. O ataque causa {@dice 2d6} de dano radiante extra ao alvo, que se torna visível, se estava invisível, e o alvo emite penumbra em um raio de 1,5 metro e não pode ficar invisível até a magia acabar.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 3° nível ou superior, o dano extra aumenta em {@dice 1d6} para cada nível do espaço acima do 2°.",
        ],
      },
    ],
    damageInflict: ["radiant"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "pó de rubi no valor de 50 po, consumido pela magia",
        consumed: true,
        cost: 5000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      ...
      "Você pode usar sua ação para realizar ataques corpo-a- corpo com magia com a lâmina ardente. Se atingir, o alvo sofrerá {@dice 3d6} de dano de fogo.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 4° nível ou superior, o dano aumenta em {@dice 1d6} para cada dois níveis do espaço acima do 2°.",
        ],
      },
    ],
    damageInflict: ["fire"],
  ...
  },
  {
    ...
    entries: [
      "Uma flecha esverdeada cintilante voa em direção de um alvo dentro do alcance e explode em um jato de ácido. Faça um ataque à distância com magia contra o alvo. Se atingir, o alvo sofre {@dice 4d4} de dano de ácido imediatamente e {@dice 2d4} de dano de ácido no final do próximo turno dele. Se errar, a flecha salpica o alvo com ácido, causando metade do dano inicial e nenhum dano no final do próximo turno dele.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 3° nível ou superior, o dano (tanto inicial quanto posterior) aumenta em {@dice 1d4} para cada nível do espaço acima do 2°.",
        ],
      },
    ],
    damageInflict: ["acid"],
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 3° nível ou superior, o dano aumenta em {@dice 1d10} para cada nível do espaço acima do 2°.",
        ],
      },
    ],
    damageInflict: ["radiant"],
  ...
  },
  {
    ...
    entries: [
      "Até seis criaturas, à sua escolha, que você possa ver, dentro do alcance, recuperam uma quantidade de pontos de vida igual a {@dice 2d8} + seu modificador de habilidade de conjuração, cada uma. Essa magia não afeta mortos-vivos ou constructos.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 3° nível ou superior, a cura aumenta em {@dice 1d8} para cada nível do espaço acima do 2°.",
        ],
      },
    ],
    miscTags: ["HL", "SGT"],
  ...
  },
  {
    ...
    entries: [
      ...
      "Realize um ataque à distância com magia para cada raio. Se atingir, o alvo sofrerá {@dice 2d6} de dano de fogo.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    entries: [
      "Um alto som estridente, dolorosamente intenso, emerge de um ponto, à sua escolha, dentro do alcance. Cada criatura, numa esfera de 3 metros de raio, centrada no ponto deve fazer um teste de resistência de Constituição. Uma criatura sofre {@dice 3d8} de dano trovejante se falhar na resistência ou metade desse dano se obtiver sucesso. Uma criatura feita de material inorgânico como pedra, cristal ou metal, tem desvantagem nesse teste de resistência.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 3° nível ou superior, o dano aumenta em {@dice 1d8} para cada nível do espaço acima do 2°.",
        ],
      },
    ],
    damageInflict: ["thunder"],
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 4° nível ou superior, o dano aumenta em {@dice 1d8} para cada dois níveis do espaço acima do 2°.",
        ],
      },
    ],
    damageInflict: ["force"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um pedaço de favo de mel e pó de jade valendo, no mínimo, 10 po, consumidos pela magia",
        consumed: true,
        cost: 1000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      ...
      "Cada vez que uma criatura mirar você com um ataque enquanto a magia durar, role um {@dice d20} para determinar se o ataque, em vez de você, mira uma das suas duplicatas.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "você conjurar essa magia usando um espaço de magia de 3° nível ou superior, você pode afetar uma criatura adicional para cada nível de espaço acima do 2°.",
        ],
      },
    ],
    savingThrow: ["constitution"],
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        name: "Armas Naturais",
        entries: [
          "Você faz crescerem garras, presas, espinhos, chifres ou armas naturais diferentes, à sua escolha. Seus ataques desarmados causam {@dice 1d6} de dano de concussão, perfurante ou cortante, como apropriado para a arma natural que você escolheu, e você é proficiente com seus ataques desarmados. Finalmente, a arma natural é mágica e você tem +1 de bônus nas jogadas de ataque e dano que você fizer com ela.",
        ],
      },
    ],
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        entries: ["O alvo tem vantagem em testes de Inteligência."],
      },
      {
        type: "entries",
        name: "Esplendor da Águia",
        entries: ["O alvo tem vantagem em testes de Carisma."],
      },
      {
        type: "entries",
        name: "Força do Touro",
      ...
      },
      {
        ...
        entries: ["O alvo tem vantagem em testes de Sabedoria."],
      },
      {
        type: "entries",
        name: "Vigor do Urso",
        entries: [
          "O alvo tem vantagem em testes de Constituição. Ele também recebe {@dice 2d6} pontos de vida temporários, que são perdidos quando a magia termina.",
        ],
      },
    ],
    entriesHigherLevel: [
  ...
  },
  {
    ...
    entries: [
      "Escolha uma objeto manufaturado de metal, como uma arma de metal ou uma armadura pesada ou média de metal, que você possa ver dentro do alcance. Você faz com que o objeto brilhe vermelho-incandescente. Qualquer criatura em contato físico com o objeto sofrerá {@dice 2d8} de dano de fogo quando você conjurar a magia. Até a magia acabar, você pode usar uma ação bônus, em cada um dos seus turnos subsequentes, para causar esse dano novamente.",
  ...
  },
  {
    ...
    entries: [
      "O solo em 6 metros quadrados, centrado num ponto dentro do alcance, se retorce e brotam cavilhas rígidas e espinhos. A área se torna terreno difícil pela duração. Quando uma criatura entrar ou se mover dentro da área, ela sofrerá {@dice 2d4} de dano perfurante para cada 1,5 metro que ela atravessar.",
    ...
    time: [
      {
        ...
        unit: "reaction",
        condition:
          "que você realiza quando vê uma criatura a até 18 metros conjurando uma magia",
      },
    ],
    range: {
      type: "point",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "incenso e pó de diamante valendo, no mínimo, 200 po, consumidos pela magia",
        consumed: true,
        cost: 20000,
      },
    },
    ...
    entries: [
      ...
      "Quando você inscreve o glifo, escolha runas explosivas ou glifo de magia.",
      {
        ...
        entries: [
          "Quando ativado, o glifo irrompe com energia mágica numa esfera com 6 metros de raio, centrada no glifo. A esfera se espalha, dobrando esquinas. Cada criatura na área deve realizar um teste de resistência de Destreza. Uma criatura sofre {@dice 5d8} de dano de ácido, elétrico, fogo, frio ou trovejante se falhar no teste de resistência (você escolhe o tipo quando cria o glifo) ou metade desse dano se obtiver sucesso.",
        ],
      },
      {
        type: "entries",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "água benta ou pó de prata e ferro valendo, no mínimo, 100 po, consumidos pela magia",
        consumed: true,
        cost: 10000,
      },
    },
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um pouco de pó de diamante valendo 25 po polvilhado sobre o alvo, consumido pela magia",
        consumed: true,
        cost: 2500,
      },
    },
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando você conjurar a magia, escolha um ponto que você possa ver dentro do alcance. Um raio de eletricidade é disparado da nuvem no ponto. Cada criatura a 1,5 metro desse ponto deve realizar um teste de resistência de Destreza. Uma criatura sofre {@dice 3d10} de dano elétrico se falhar no teste, ou metade desse dano se passar. Em cada um dos seus turnos, até a magia acabar, você pode usar sua ação para convocar um relâmpago dessa forma novamente, afetando o mesmo ponto ou um diferente.",
      "Se você estiver a céu aberto em condições tempestuosas quando conjurar essa magia, a magia lhe dá controle sobre a tempestade existente ao invés de criar uma nova. Sob tais condições, o dano da magia aumenta em {@dice 1d10}.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 4° nível ou superior, o dano aumenta em {@dice 1d10} para cada nível do espaço acima do 3°.",
        ],
      },
    ],
    damageInflict: ["lightning"],
  ...
  },
  {
    ...
    entries: [
      "Você arremessa uma arma não-mágica ou dispara uma munição não-mágica no ar para criar um cone de armas idênticas que se lançam a frente e então desaparecem. Cada criatura num cone de 18 metros, deve ser bem sucedida num teste de resistência de Destreza. Uma criatura sofre {@dice 3d8} de dano se falhar na resistência, ou metade desse dano num sucesso. O tipo do dano é o mesmo da arma ou munição usada como componente.",
    ],
    savingThrow: ["dexterity"],
    areaTags: ["N"],
    classes: {
  ...
  },
  {
    ...
    entries: [
      ...
      "O vazio cria uma dobra no tecido do espaço e a área é de terreno difícil. Qualquer criatura que começar seu turno na área sofre {@dice 2d6} de dano de frio. Qualquer criatura que terminar seu turno na área, deve ser bem sucedida num teste de resistência de Destreza ou sofrerá {@dice 2d6} de dano de ácido, à medida que tentáculos leitosos extraterrestres se esfregam contra ela.",
    ],
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando você conjura essa magia, você pode designar qualquer quantidade de criaturas que você possa ver para não serem afetadas por ela. O deslocamento de uma criatura afetada é reduzido à metade na área e, quando a criatura entrar na área pela primeira vez num turno ou começar seu turno nela, ela deve realizar um teste de resistência de Sabedoria. Se falhar na resistência, a criatura sofrerá {@dice 3d8} de dano radiante (se você for bom ou neutro) ou {@dice 3d8} de dano necrótico (se você for mau). Com um sucesso na resistência, a criatura sofre metade desse dano.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 4° nível ou superior, o dano aumenta em {@dice 1d8} para cada nível do espaço acima do 3°.",
        ],
      },
    ],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um foco valendo, no mínimo, 100 po, também um chifre cravejado de joias para ouvir ou um olho de vidro para ver",
        cost: 10000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      "Energia curativa irradia de você em uma aura com 9 metros de raio. Até a magia acabar, a aura se move mantendo-se centrada em você. Você pode usar uma ação bônus para fazer com que uma criatura na aura (incluindo você) recupere {@dice 2d6} pontos de vida.",
    ],
    miscTags: ["HL"],
    areaTags: ["R"],
    classes: {
  ...
  },
  {
    ...
    entries: [
      "Da próxima vez que você atingir uma criatura com um ataque com arma, antes do fim da magia, sua arma emite uma luz intensa, e o ataque causa {@dice 3d8} de dano radiante extra ao alvo. Além disso, o alvo deve ser bem sucedido num teste de resistência de Constituição ou ficará cego até a magia acabar.",
  ...
  },
  {
    ...
    entries: [
      "Poder sagrado irradia de você em uma aura de 9 metros de raio, despertando a audácia nas criaturas amigáveis. Até o final da magia, a aura se move, se mantendo centrada em você. Enquanto estiver na aura, cada criatura não-hostil (incluindo você) causa {@dice 1d4} de dano radiante extra quando atingir com ataques com arma.",
    ],
    damageInflict: ["radiant"],
    areaTags: ["R"],
    classes: {
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 4° nível ou superior, o dano aumenta em {@dice 1d6} para cada nível do espaço acima do 3°.",
        ],
      },
    ],
    damageInflict: ["fire"],
  ...
  },
  {
    ...
    entries: [
      "Um relâmpago forma uma linha de 30 metros de comprimento e 1,5 metro de largura que é disparado por você em uma direção, à sua escolha. Cada criatura na linha deve realizar um teste de resistência de Destreza. Uma criatura sofre {@dice 8d6} de dano elétrico se falhar na resistência ou metade desse dano se obtiver sucesso.",
  ...
  },
  {
    ...
    entries: [
      "À medida que você brada palavras de restauração, até seis criaturas, à sua escolha, que você possa ver, dentro do alcance, recuperam uma quantidade de pontos de vida igual a {@dice 1d4} + seu modificador de habilidade de conjuração. Essa magia não afeta mortos-vivos ou constructos.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 4° nível ou superior, a cura aumenta em {@dice 1d4} para cada nível do espaço acima do 3°.",
        ],
      },
    ],
    miscTags: ["HL", "SGT"],
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando a muralha aparece, cada criatura dentro da área dela deve realizar um teste de resistência de Força. Uma criatura sofre {@dice 3d8} de dano de concussão se falhar na resistência, ou metade desse dano se obtiver sucesso.",
    ...
    entries: [
      "Você toca uma criatura e a criatura deve ser bem sucedida em um teste de resistência de Sabedoria ou será amaldiçoada pela duração da magia. Quando você conjura essa magia, escolha a natureza da maldição dentre as seguintes opções:",
      {
        ...
        items: [
          ...
          "Enquanto o alvo estiver amaldiçoado, seus ataques e magias causam {@dice 1d8} de dano necrótico extra a ele.",
        ],
      },
      "Uma magia de Remover Maldição encerra esse efeito. À escolha do Mestre, você pode escolher um efeito de maldição alternativo, mas não deve ser mais poderoso do que os descritos acima. O Mestre tem a palavra final sobre o efeito de tal maldição.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você lançar essa magia usando um espaço de magia de 4º nível ou superior, a duração é de concentração, até 10 minutos. Se você usar um espaço de magia de 5º nível ou superior, a duração é de 8 horas. Se você usar um espaço de magia de 7º nível ou superior, a duração é de 24 horas. Se você usar um slot de magia de 9º nível, o feitiço dura até que seja dissipado. Usar um espaço de magia de 5º nível ou superior concede uma duração que não requer concentração.",
        ],
      },
    ],
    damageInflict: ["necrotic"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um diamante no valor de 300 po, consumido pela magia",
        consumed: true,
        cost: 30000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      "Uma arma não-mágica que você tocar se torna uma arma mágica. Escolha um dos tipos de dano a seguir: ácido, elétrico, frio, fogo ou trovejante. Pela duração, a arma tem +1 de bônus nas jogadas de ataque e causa {@dice 1d4} de dano extra, do tipo de elemento escolhido, ao atingir.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 5° ou 6° nível, o bônus nas jogadas de ataque aumenta pra +2 e o dano extra aumenta para {@dice 2d4}. Quando você usar um espaço de magia de 7° nível ou superior, o bônus aumenta para +3 e o dano extra aumenta para {@dice 3d4}.",
        ],
      },
    ],
    damageInflict: ["acid", "cold", "fire", "lightning", "thunder"],
  ...
  },
  {
    ...
    entries: [
      "Da próxima vez que você realizar um ataque com uma arma à distância enquanto a magia durar, a munição da arma ou a própria arma, se ela for uma arma de arremesso, se transforma num relâmpago. Realize uma jogada de ataque normal. O alvo sofre {@dice 4d8} de dano elétrico se atingir ou metade desse dano se errar, ao invés do dano normal da arma.",
      "Independentemente de você acertar ou errar, cada criatura a até 3 metros do alvo deve realizar um teste de resistência de Destreza. Cada uma dessas criaturas sofre {@dice 2d8} de dano elétrico se falhar na resistência ou metade desse dano se obtiver sucesso. A munição ou arma então, volta a sua forma normal.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 4° nível ou superior, o dano de ambos os efeitos da magia aumenta em {@dice 1d8} para cada nível do espaço acima do 3°.",
        ],
      },
    ],
    damageInflict: ["lightning"],
  ...
  },
  {
    ...
    entries: [
      ...
      "Se a criatura tentar conjurar uma magia com tempo de conjuração maior que 1 rodada, jogue um {@dice d20}. Se cair 11 ou maior, a magia não surte efeito até o próximo turno da criatura e a criatura deve usar sua ação nesse turno para completar a magia. Se ela não puder, a magia é perdida.",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "pó de diamante no valor de 100 po, consumido pela magia",
        consumed: true,
        cost: 10000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      ...
      "Se você aparecer em um lugar que já esteja ocupado por um objeto ou uma criatura, você e qualquer criatura viajando com você, sofrem {@dice 4d6} de dano de energia cada um e a magia falha em teletransportar vocês.",
    ],
    damageInflict: ["force"],
    miscTags: ["SGT"],
    classes: {
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando uma criatura adentrar a área afetada pela primeira vez em um turno ou começar o turno dela lá, a criatura deve ser bem sucedida num teste de resistência de Destreza ou sofrerá {@dice 3d6} de dano de concussão e estará impedida pelos tentáculos até o fim da magia. Uma criatura que começar seu turno na área e já estiver impedida pelos tentáculos sofre {@dice 3d6} de dano de concussão.",
    ...
    damageInflict: ["bludgeoning"],
    savingThrow: ["dexterity"],
    opposedCheck: ["strength", "dexterity"],
    miscTags: ["SGT"],
    areaTags: ["Q"],
    classes: {
      fromClassList: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um baú requintado, de 90 cm por 60 cm por 60 cm, construído com materiais raros valendo, no mínimo, 5.000 po e uma réplica Miúda feita do mesmo material valendo, no mínimo, 50 po",
        cost: 500000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      ...
      "No começo de cada um dos seus turnos, o cão tenta morder uma criatura a 1,5 metro dele que seja hostil a você. O bônus de ataque do cão é igual ao seu modificador de habilidade de conjuração + seu bônus de proficiência. Se atingir, ele causa {@dice 4d8} de dano perfurante.",
    ],
    damageInflict: ["piercing"],
    miscTags: ["SGT"],
    classes: {
  ...
  },
  {
    ...
    components: {
      v: true,
      s: true,
      m: "um punhado de pelo de morcego",
    },
    duration: [
      {
        type: "timed",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "incenso e uma oferenda apropriada para sacrifício à sua religião, juntos valendo, no mínimo, 25 po, consumidos pela magia",
        consumed: true,
        cost: 2500,
      },
    },
  ...
  },
  {
    ...
    entries: [
      ...
      "Um alvo afetado não pode realizar reações e deve rolar um {@dice d10} no início de cada um dos seus turnos para determinar seu comportamento nesse turno.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjura esta magia usando um espaço de magia de 5º nível ou superior, o raio da esfera aumenta 1,5m para cada nível de espaço acima do 4º.",
        ],
      },
    ],
    savingThrow: ["wisdom"],
  ...
  },
  {
    ...
    components: {
      v: true,
      s: true,
      m: "um pouco de fósforo ou um vaga- lume",
    },
    duration: [
      {
        type: "timed",
    ...
    entries: [
      ...
      "Além disso, sempre que uma criatura a 1,5 metro de você atingir você com um ataque corpo-a-corpo, o escudo expele chamas. O atacante sofre {@dice 2d8} de dano de fogo do escudo quente ou {@dice 2d8} de dano de frio do escudo frio.",
    ],
  ...
  },
  {
    ...
    entries: [
      "Uma rajada de pedras de gelo batem no chão em um cilindro de 6 metros de raio por 12 metros de altura, centrado num ponto dentro do alcance. Cada criatura no cilindro deve realizar um teste de resistência de Destreza. Uma criatura sofre {@dice 2d8} de dano de concussão e {@dice 4d6} de dano de frio se falhar na resistência ou metade desse dano se obtiver sucesso",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 5° nível ou superior, o dano de concussão aumenta em {@dice 1d8} para cada nível do espaço acima do 4°.",
        ],
      },
    ],
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando a muralha aparece, cada criatura dentro da área dela deve realizar um teste de resistência de Destreza. Se falhar na resistência, uma criatura sofrerá {@dice 5d8} de dano, ou metade desse dano se passar na resistência.",
      "Um lado da muralha, escolhido por você no momento da conjuração da magia, causa {@dice 5d8} de dano de fogo a cada criatura que terminar o turno dela a até 3 metros desse lado ou dentro da muralha. Uma criatura sofre o mesmo dano quando entra na muralha pela primeira vez num turno ou termina seu turno nela. O outro lado da muralha não causa dano algum.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 5° nível ou superior, o dano aumenta em {@dice 1d8} para cada nível do espaço acima do 4°.",
        ],
      },
    ],
    damageInflict: ["fire"],
    ...
    entries: [
      ...
      },
      {
        ...
        entries: [
          ...
          "Quando uma criatura entrar no vórtice pela primeira vez no turno dela ou começar seu turno dentro dele, ela deve realizar um teste de resistência de Força. Se falhar, a criatura sofre {@dice 2d8} de dano de concussão e estará presa no vórtice até a magia acabar. Se passar na resistência, a criatura sofre metade do dano e não estará presa no vórtice. Uma criatura presa no vórtice pode usar sua ação para tentar nadar para fora do vórtice como descrito acima, mas terá desvantagem no teste de Força (Atletismo) para fazer isso.",
          "A primeira vez a cada turno que um objeto entrar no vórtice, o objeto sofre {@dice 2d8} de dano de concussão; esse dano se repete a cada rodada que ele permanecer no vórtice.",
        ],
      },
    ],
    damageInflict: ["bludgeoning"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "pó de diamante valendo, no mínimo, 100 po, consumido pela magia",
        consumed: true,
        cost: 10000,
      },
    },
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma joia valendo, no mínimo, 1.000 po, consumida pela magia",
        consumed: true,
        cost: 100000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando uma criatura entra na área da magia pela primeira vez no turno dela ou começa seu turno lá, essa criatura deve realizar um teste de resistência de Constituição. A criatura sofre {@dice 5d8} de dano de veneno, ou metade desse dano, se passar no teste. As criaturas serão afetadas mesmo se prenderem a respiração ou não precisarem respirar.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 6° nível ou superior, o dano aumenta em {@dice 1d8} para cada nível do espaço acima do 5°.",
        ],
      },
    ],
    damageInflict: ["poison"],
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você lança essa magia usando um slot de magia de 6º nível ou superior, o nível de desafio aumenta 1 em cada nível de slot acima do 5º.",
        ],
      },
    ],
    miscTags: ["SMN"],
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando a área aparece, cada criatura dentro dela deve realizar um teste de resistência de Constituição. Uma criatura sofre {@dice 4d10} de dano perfurante se falhar na resistência ou metade desse dano se passar. Uma criatura deve, também, realizar um teste de resistência quando entrar na área da magia pela primeira vez num turno ou terminar seu turno nela.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 6° nível ou superior, o dano aumenta em {@dice 1d10} para cada nível do espaço acima do 5°.",
        ],
      },
    ],
    damageInflict: ["piercing"],
  ...
  },
  {
    ...
    components: {
      v: true,
      m: {
        text: "giz e tintas raros infundidos com pedras preciosas no valor de 50 po, consumidos pela magia",
        consumed: true,
        cost: 5000,
      },
    },
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "incenso valendo, no mínimo, 250 po, consumido pela magia e quatro tiras de marfim valendo, no mínimo, 50 po cada",
        consumed: true,
        cost: 25000,
      },
    },
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um foco valendo, no mínimo, 1.000 po, como uma bola de cristal, espelho de prata ou fonte cheia de água benta",
        cost: 100000,
      },
    },
    duration: [
    ...
    entries: [
      ...
      {
        type: "table",
        caption: "Conhecimento do Alvo",
        colLabels: ["Conhecimento", "Modif. de Resistência"],
      ...
      {
        type: "table",
        caption: "Conexão com o Alvo",
        colLabels: ["Conexão", "Modif. de Resistência"],
        colStyles: ["col-11", "col-1 text-center"],
        rows: [
          ["Descrição ou foto", "-2"],
  ...
  },
  {
    ...
    entries: [
      "Você impõe um comando mágico a uma criatura que você possa ver, dentro do alcance, forçando-a a fazer algum serviço ou reprimindo-a por alguma ação ou curso de atividade, como você decidir. Se a criatura puder compreender você, ela deve ser bem sucedida num teste de resistência de Sabedoria ou ficará enfeitiçada por você pela duração. Enquanto a criatura estiver enfeitiçada por você, ela sofrerá {@dice 5d6} de dano psíquico toda vez que ela agir de maneira diretamente contrária às suas instruções, mas não mais de uma vez por dia. Uma criatura que não puder compreender você não é afetada por essa magia.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        name: "Punho Cerrado",
        entries: [
          "A mão golpeia uma criatura ou objeto a 1,5 metro dela. Realize uma jogada de ataque corpo-a-corpo com magia para a mão usando suas estatísticas de jogo. Se atingir, o alvo sofre {@dice 4d8} de dano de energia.",
        ],
      },
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 6° nível ou superior, o dano da opção punho cerrado aumenta em {@dice 2d8} e o dano da mão esmagadora aumenta em {@dice 2d6} para cada nível do espaço acima do 5°.",
        ],
      },
    ],
  ...
  },
  {
    ...
    entries: [
      "Uma explosão de ar gelado irrompe das suas mãos. Cada criatura dentro do cone de 18 metros, deve realizar um teste de resistência de Constituição. Uma criatura sofre {@dice 8d8} de dano de frio se falhar na resistência, ou metade desse dano se passar.",
  ...
  },
  {
    ...
    entries: [
      "Você golpeia o chão, criando uma explosão de energia divina que se propaga de você. Cada criatura, à sua escolha, a até 9 metros de você, deve ser bem sucedida em um teste de resistência de Constituição ou sofrerá {@dice 5d5} de dano trovejante, assim como {@dice 5d6} de dano radiante ou necrótico (à sua escolha), e será derrubada no chão. Uma criatura que obtenha sucesso no teste de resistência sofre metade desse dano e não é derrubada no chão.",
    ],
  ...
  },
  {
    ...
    entries: [
      "Uma coluna vertical de fogo divino emerge de baixo para os céus, no local que você especificar. Cada criatura num cilindro de 3 metros de raio por 12 metros de altura, centrado num ponto dentro do alcance, deve realizar um teste de resistência de Destreza. Uma criatura sofre {@dice 4d6} de dano de fogo e {@dice 4d6} de dano radiante se falhar na resistência, ou metade desse dano se obtiver sucesso.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 6° nível ou superior, o dano de fogo ou o dano radiante (à sua escolha) aumenta em {@dice 1d6} por nível do espaço acima do 5°.",
        ],
      },
    ],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "ervas, óleos e incenso valendo, no mínimo, 1.000 po, consumidos pela magia",
        consumed: true,
        cost: 100000,
      },
    },
    ...
    entries: [
      ...
      {
        type: "entries",
        name: "Interferência Extradimensional.",
        entries: [
      ...
      {
        type: "entries",
        name: "Vulnerabilidade à Energia.",
        entries: [
  ...
  },
  {
    ...
    entries: [
      "Uma onda de energia curativa emerge de um ponto, à sua escolha, dentro do alcance. Escolha até seis criaturas numa esfera de 9 metros de raio, centrada nesse ponto. Cada alvo recupera uma quantidade de pontos de vida igual a {@dice 3d8} + seu modificador de habilidade de conjuração. A magia não afeta mortos-vivos ou constructos.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 6° nível ou superior, a cura aumenta em {@dice 1d8} para cada nível do espaço acima do 5°.",
        ],
      },
    ],
    miscTags: ["HL"],
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjura essa magia usando um slot de magia de 6º nível ou superior, o cubo aumenta 1,5m para cada nível de slot acima do 5º.",
        ],
      },
    ],
    classes: {
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um diamante valendo, no mínimo, 500 po, consumido pela magia",
        consumed: true,
        cost: 50000,
      },
    },
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um slot de magia de 6º nível ou superior, poderá animar dois objetos adicionais para cada nível de slot acima do 5º.",
        ],
      },
    ],
    damageInflict: ["bludgeoning", "piercing", "slashing"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma ágata valendo, no mínimo, 1.000 po que será consumida pela magia",
        consumed: true,
        cost: 100000,
      },
    },
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "óleos e unguentos raros valendo, no mínimo, 1.000 po, consumidos pela magia",
        consumed: true,
        cost: 100000,
      },
    },
    ...
    entries: [
      ...
      "A magia forma um novo corpo para que a criatura habite, o que, provavelmente, fará com que a raça da criatura mude. O Mestre rola um {@dice d100} e consulta a tabela seguinte para determinar qual forma a criatura terá quando voltar a vida, ou o Mestre pode escolher uma forma.",
      {
        type: "table",
      ...
      "A criatura reencarnada recorda sua vida e experiências anteriores. Ele mantém as capacidades que tinha em sua forma original, exceto que troca sua raça original pela nova e altera suas características raciais de acordo.",
    ],
    miscTags: ["HL"],
    classes: {
      fromClassList: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma borrifada de água benta, incensos raros e pó de rubi valendo, no mínimo, 1.000 po",
        cost: 100000,
      },
    },
    duration: [
    ...
    entries: [
      ...
      "Além disso, a magia causa dano a certos tipos de criatura, à sua escolha, quando a conjurar. Escolha um ou mais dentre os seguintes: celestiais, corruptores, elementais, fadas ou mortos-vivos. Quando uma criatura escolhida entrar na área da magia pela primeira vez em um turno ou começa seu turno nela, a criatura sofre {@dice 5d6} de dano radiante ou necrótico (à sua escolha, quando você conjura a magia).",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "incenso aceso, uma porção de enxofre e óleo, uma corda amarrada, uma porção de sangue de tribulo brutal e um pequeno bastão de prata valendo, no mínimo, 10 po",
        cost: 1000,
      },
    },
    duration: [
    ...
    entries: [
      ...
      "Toda a área protegida irradia magia. Dissipar magia lançada em um efeito específico, se for bem-sucedida, remove apenas esse efeito.",
      "Você pode criar uma estrutura permanentemente protegida conjurando essa magia todos os dias durante um ano.",
    ],
    miscTags: ["PRM"],
    areaTags: ["Q"],
    classes: {
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma safira no valor de 1.000 po",
        cost: 100000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma tigela encrustada de gemas valendo, no mínimo, 1.000 po, que é consumida pela magia",
        consumed: true,
        cost: 100000,
      },
    },
    ...
    entries: [
      ...
      "Uma criatura que participe do banquete ganha diversos benefícios. A criatura é curada de todas as doenças e venenos, torna-se imune a veneno e a ser amedrontada e faz todos os seus testes de resistência com vantagem. Seu máximo de pontos de vida também aumenta em {@dice 2d10} e ela ganha a mesma quantidade de pontos de vida. Esses benefícios duram por 24 horas.",
    ],
    damageImmune: ["poison"],
    areaTags: ["MT"],
    classes: {
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando a muralha aparece, cada criatura dentro da área deve realizar um teste de resistência de Destreza. Se falhar na resistência, uma criatura sofrerá {@dice 7d8} de dano perfurante ou metade desse dano se obtiver sucesso.",
      "Uma criatura pode se mover através da muralha, embora lentamente e dolorosamente. Para cada 1,5 metro que a criatura atravesse da muralha, ela deve gastar 6 metros de movimento. Além disso, a primeira vez que a criatura entrar na muralha num turno ou termina o turno nela, ela deve fazer um teste de resistência de Destreza. Ela sofre {@dice 7d8} de dano cortante se falhar na resistência ou metade desse dano se obtiver sucesso.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 7° nível ou superior, ambos os tipos de dano aumentam em {@dice 1d8} para cada nível do espaço acima do 6°.",
        ],
      },
    ],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um conjunto de ferramentas de adivinhação – como ossos, bastões de marfim, dentes ou runas esculpidas – no valor de 100 po e um objeto do lugar que você deseja encontrar",
        cost: 10000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "unguento para os olhos no valor de 25 po; ele é feito de pó de cogumelo, açafrão e gordura; e é consumido pela magia",
        consumed: true,
        cost: 2500,
      },
    },
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando uma criatura entrar a área da muralha pela primeira vez em um turno, ou começar seu turno nela, a criatura deve realizar um teste de resistência de Destreza. Se falhar, a criatura sofrerá {@dice 6d10} de dano cortante. Em um sucesso, a criatura sofre metade desse dano.",
    ],
    damageInflict: ["slashing"],
    savingThrow: ["dexterity"],
    areaTags: ["W"],
  ...
  },
  {
    ...
    entries: [
      ...
      "Um alvo deve realizar um teste de resistência de Destreza. O alvo sofre {@dice 10d8} de dano elétrico se falhar no teste ou metade desse dano se for bem sucedido.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma estátua sua esculpida em marfim e decorada com gemas valendo, no mínimo, 1.500 po",
        cost: 150000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      "Um globo frigido de energia gelada é arremessado das pontas dos seus dedos para um ponto, à sua escolha, dentro do alcance, onde ele explode numa esfera de 18 metros de raio. Cada criatura dentro da área deve realizar um teste de resistência de Constituição. Se falhar na resistência, uma criatura sofre {@dice 10d6} de dano de frio. Se obtiver sucesso na resistência, ela sofre metade desse dano.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 7° nível ou superior, o dano aumenta em {@dice 1d6} para cada nível do espaço acima do 6°.",
        ],
      },
    ],
    damageInflict: ["cold"],
  ...
  },
  {
    ...
    entries: [
      "Um raio de luz brilhante surge da sua mão em uma linha de 18 metros de comprimento por 1,5 metro de largura. Cada criatura na linha deve realizar um teste de resistência de Constituição. Se falhar na resistência, uma criatura sofrerá {@dice 6d8} de dano radiante e ficará cega até seu próximo turno. Se passar na resistência, ela sofrerá metade desse dano e não ficará cega pela magia. Mortos- vivos e limos tem desvantagem nos seus testes de resistência.",
  ...
  },
  {
    ...
    entries: [
      ...
      "Se a muralha passar pelo espaço ocupado por uma criatura quando ela surgir, a criatura na área será empurrada para um dos lados da muralha (você escolhe qual lado) e deve realizar um teste de resistência de Destreza. Se falhar na resistência, a criatura sofrerá {@dice 10d6} de dano de frio ou metade desse dano se passar na resistência.",
      ...
      "resistência de Constituição. Essa criatura sofrerá {@dice 5d6} de dano de frio se fracassar na resistência, ou metade desse dano se obtiver sucesso.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 7° nível ou superior, o dano causado quando ela aparece aumenta em {@dice 2d6} e o dano por atravessar através da camada de ar gelado aumenta em {@dice 1d6} para cada nível do espaço acima do 6°.",
        ],
      },
    ],
    damageInflict: ["cold"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um pouco de lã e pó de jade valendo, no mínimo, 25 po",
        cost: 2500,
      },
    },
    duration: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "o pó de uma pérola negra esmagada valendo, no mínimo, 500 po.",
        cost: 50000,
      },
    },
    duration: [
    ...
    entries: [
      "Uma esfera de energia negativa ondula em um raio de 18 metros de um ponto ao alcance. Cada criatura na área deve realizar um teste de resistência de Constituição. Um alvo sofre {@dice 8d6} de dano necrótico se falhar no seu teste de resistência, ou metade desse dano se passar.",
    ],
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 7° nível ou superior, o dano aumenta em {@dice 2d6} para cada nível do espaço acima do 6°.",
        ],
      },
    ],
    damageInflict: ["necrotic"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um pote de barro cheio de terra de sepultura, um pote de barro cheio de água salobra, e uma ônix negra no valor de 150 po, para cada corpo.",
        cost: 15000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma gema, cristal, relicário ou algum outro tipo de recipiente ornamental valendo, no mínimo, 500 po",
        cost: 50000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      ...
      "Uma criatura afetada por essa magia deve realizar um teste de resistência de Destreza. Se falhar na resistência, o alvo sofrerá {@dice 10d6 + 40} de dano de energia. Se esse dano reduzir os pontos de vida do alvo a 0, ele será desintegrado.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Se você conjurar essa magia usando um espaço de magia de 7° nível ou superior, o dano aumenta em {@dice 3d6} para cada nível do espaço acima do 6°.",
        ],
      },
    ],
    damageInflict: ["force"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "mercúrio, fósforo e pó de diamante e opala, com um valor total de, no mínimo, 1.000 po, consumidos pela magia",
        consumed: true,
        cost: 100000,
      },
    },
    ...
    entries: [
      ...
      },
      {
        ...
        name: "Morte.",
        entries: [
          "Cada alvo deve realizar um teste de resistência de Constituição, sofrendo {@dice 10d10} de dano necrótico se falhar na resistência ou metade desse dano se passar na resistência.",
        ],
      },
      {
        type: "entries",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um portal em miniatura esculpido em marfim, um pedaço de mármore polido e uma pequena colher de prata, cada item valendo, no mínimo, 5 po",
        cost: 500,
      },
    },
    duration: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma haste metálica bifurcada valendo, no mínimo, 250 po, sintonizada com um plano de existência em particular",
        cost: 25000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      ...
      "O destino que você escolher deve ser conhecido por você e deve ser no mesmo plano de existência que você está. Sua familiaridade com o destino determina se você chegará nele com sucesso. O Mestre rola um {@dice d100} e consulta a tabela.",
      "**Consultar Tabela no Livro**",
      ...
      "Fora do Alvo. Você e seu grupo (ou objeto alvo) aparecem a uma distância aleatória fora do destino em uma direção aleatória. A distância do alvo é {@dice 1d10 x 1d10} por cento da distância que você viajou. Por exemplo, se você tentou viajar 180 quilômetros, mas apareceu fora do alvo e rolou um 5 e um 3 nos dois {@dice d10}s, então você saiu do alvo 15 por cento ou 27 quilômetros. O Mestre determina a direção de fora do alvo aleatoriamente rolando um {@dice d8} e designando 1 como norte, 2 como nordeste, 3 como leste e assim por diante ao redor dos pontos cardeais. Se você seria teletransportado para uma cidade costeira, podendo cair a 27 quilômetros dela, no mar, você poderia ter problemas.",
      ...
      "Fiasco. A mágica imprevisível da magia resulta em uma jornada difícil. Cada criatura teletransportada (ou o objeto alvo) sofrem {@dice 3d10} de dano de energia e o Mestre rola novamente a tabela para ver onde você foi parar (fiascos múltiplos podem ocorrer, causando dano a cada vez).",
    ],
    miscTags: ["SGT"],
    classes: {
      fromClassList: [
  ...
  },
  {
    ...
    entries: [
      ...
      "O dano base da magia é {@dice 12d6}. Se até o final do seu turno, a conta ainda não tiver sido detonada, o dano aumenta em {@dice 1d6}.",
    ...
    entriesHigherLevel: [
      {
        name: "At Higher Levels",
        entries: [
          "Quando você conjurar essa magia usando um espaço de magia de 8° nível ou superior, o dano base aumenta e {@dice 1d6} para cada nível do espaço acima do 7°.",
        ],
      },
    ],
    damageInflict: ["fire"],
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "pó de rubi no valor de 1.500 po",
        cost: 150000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "espada de platina em miniatura com cabo e pomo de cobre e zinco valendo, no mínimo, 250 po",
        cost: 25000,
      },
    },
    duration: [
    ...
    entries: [
      ...
      "Quando a espada aparece, você realiza um ataque com magia contra um alvo, à sua escolha, a 1,5 metro da espada. Se atingir, o alvo sofre {@dice 3d10} de dano de energia. Até a magia acabar, você pode usar uma ação bônus, em cada um dos seus turnos, para mover a espada até 6 metros para um local que você possa ver e repetir esse ataque contra o mesmo alvo ou um diferente.",
    ],
    damageInflict: ["force"],
    spellAttack: ["M"],
    miscTags: ["SGT"],
  ...
  },
  {
    ...
    entries: [
      "Oito raios de luz multicoloridos lampejam da sua mão. Cada raio é uma cor diferente e tem poderes e propósitos diferentes. Cada criatura em um cone de 18 metros deve realizar um teste de resistência de Destreza. Para cada alvo, role um {@dice d8} para determinar qual cor de raio afetou ele.",
      {
        type: "entries",
        name: "1-Vermelho",
        entries: [
          "O alvo sofre {@dice 10d6} de dano de fogo se falhar na resistência ou metade desse dano se obtiver sucesso.",
        ],
      },
      {
        type: "entries",
        name: "2-Laranja",
        entries: [
          "O alvo sofre {@dice 10d6} de dano de ácido se falhar na resistência ou metade desse dano se obtiver sucesso.",
        ],
      },
      {
        type: "entries",
        name: "3-Amarelo",
        entries: [
          "O alvo sofre {@dice 10d6} de dano elétrico se falhar na resistência ou metade desse dano se obtiver sucesso.",
        ],
      },
      {
        type: "entries",
        name: "4-Verde",
        entries: [
          "O alvo sofre {@dice 10d6} de dano de veneno se falhar na resistência ou metade desse dano se obtiver sucesso.",
        ],
      },
      {
        type: "entries",
        name: "5-Azul",
        entries: [
          "O alvo sofre {@dice 10d6} de dano de frio se falhar na resistência ou metade desse dano se obtiver sucesso.",
        ],
      },
      {
        type: "entries",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma pequena réplica sua feita com materiais valendo, no mínimo, 5 po",
        cost: 500,
      },
    },
    duration: [
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "neve ou gelo em quantidade suficiente para fazer uma cópia em tamanho real da criatura duplicada; algum cabelo, recortes de unha ou outro pedaço do corpo da criatura, colocado dentro da neve ou gelo; e pó de rubi no valor de 1.500 po, polvilhado sobre a duplicata e consumido pela magia",
        consumed: true,
        cost: 150000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      "Você envia energia negativa na direção de uma criatura que você possa ver, dentro do alcance, causando dores severas nela. O alvo deve realizar um teste de resistência de Constituição. Ele sofre {@dice 7d8 + 30} de dano necrótico se falhar na resistência, ou metade desse dano se obtiver sucesso.",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um diamante valendo, no mínimo, 1.000 po, consumido pela magia",
        consumed: true,
        cost: 100000,
      },
    },
  ...
  },
  {
    ...
    entries: [
      "Você toca uma criatura e estimula sua habilidade de cura natural. O alvo recupera {@dice 4d8 + 15} pontos de vida. Pela duração da magia o alvo recupera 1 ponto de vida no início de cada turno dela (10 pontos de vida por minuto).",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um composto de pós de diamante, esmeralda, rubi e safira valendo, no mínimo, 5.000 po, consumidos pela magia",
        consumed: true,
        cost: 500000,
      },
    },
  ...
  {
    name: "Campo Antimagia  abjuração",
    source: "PHB PT-BR",
    page: 213,
    level: 8,
    school: "A",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um minúsculo relicário valendo, no mínimo, 1.000 po, contendo uma relíquia sagrada, como um pedaço de tecido do robe de um santo ou um pedaço de pergaminho de um texto religioso",
        cost: 100000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando a nuvem aparece, cada criatura deve realizar um teste de resistência de Destreza. Uma criatura sofre {@dice 10d8} de dano de fogo se falhar na resistência ou metade desse dano se passar. Uma criatura deve, também, realizar um teste de resistência quando entrar na área da magia pela primeira vez num turno ou terminar seu turno nela.",
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando a muralha aparece, cada criatura dentro da área deve realizar um teste de resistência de Força. Se falhar na resistência, uma criatura sofrerá {@dice 6d10} de dano de concussão ou metade desse dano se passar na resistência.",
      "No início de cada um dos seus turnos, após a muralha aparecer, ela, junto com qualquer criatura nela, se afasta 15 metros de você. Qualquer criatura Enorme ou menor dentro da muralha ou no espaço que a muralha entrar quando ela se mover, deve ser bem sucedida num teste de resistência de Força ou sofrerá {@dice 5d6} de dano de concussão. Uma criatura pode sofrer esse dano apenas uma vez por rodada. No final do turno, a altura da muralha é reduzida em 15 metros e o dano que as criaturas sofrem da magia nas rodadas subsequentes é reduzido em {@dice 1d10}. Quando a muralha chegar a 0 metro de altura, a magia acaba.",
  ...
  },
  {
    ...
    entries: [
      "Você ataca a mente de uma criatura que você possa ver, dentro do alcance, tentando despedaçar seu intelecto e personalidade. O alvo sofre {@dice 4d6} de dano psíquico e deve realizar um teste de resistência de Inteligência.",
  ...
  },
  {
    ...
    entries: [
      ...
      "Essa magia pode ter efeitos adicionais a depender do terreno na área, como determinado pelo Mestre.",
      {
        ...
        name: "Fissuras.",
        entries: [
          "Fissuras se abrem por toda área da magia, no começo do seu próximo turno, após você conjurar a magia. Um total de {@dice 1d6} dessas fissuras se abrem em locais escolhidos pelo Mestre. Cada um tem {@dice 1d10 x 3} metros de profundidade, 3 metros de largura e se estende de uma extremidade até o lado oposto da área da magia. Uma criatura que estiver em um ponto onde uma fissura se abriu deve ser bem sucedido num teste de resistência de Destreza ou cairá dentro dela. Uma criatura que obtenha sucesso na resistência se move com a margem da fissura, à medida que ela se abre.",
  ...
  },
  {
    ...
    entries: [
      "Luz solar brilhante lampeja num raio de 18 metros, centrada num ponto, à sua escolha, dentro do alcance. Cada criatura nessa luz, deve realizar um teste de resistência de Constituição. Com uma falha na resistência, uma criatura sofrerá {@dice 12d6} de dano radiante e ficará cega por 1 minuto. Se obtiver sucesso na resistência, ela sofrerá metade desse dano e não ficará cega por essa magia. Mortos-vivos e limos tem desvantagem nos seus testes de resistência.",
  ...
  },
  {
    ...
    entries: [
      ...
      "Quando você conjurar essa magia, você muda as condições climáticas atuais, que são determinadas pelo Mestre baseado no ambiente e estação. Você pode mudar a precipitação, temperatura e vento. Leva {@dice 1d4 x 10} minutos para as novas condições fazerem efeito. Quando a magia terminar, o clima, gradualmente, volta ao normal.",
      "Quando você altera as condições climáticas, encontre a condição atual nas tabelas a seguir e mude em um estágio, para cima ou para baixo. Quando mudar o vento, você pode mudar a direção do mesmo.",
      {
        type: "table",
        caption: "Chuva",
        colLabels: ["Nível", "Condição"],
        colStyles: ["col-1 text-center", "col-11"],
        rows: [
          ["1", "Claro"],
          ["2", "Nuvens esparças"],
          ["3", "Neblina rasa"],
          ["4", "Chuva, neblina ou geada"],
          ["5", "Chuva Torrencial ou nevasca"],
        ],
      },
      {
        type: "table",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um pergaminho de representação ou uma estatueta esculpida para se parecer com o alvo e um componente especial, que varia de acordo com a versão da magia que você escolher, valendo, no mínimo, 500 po por Dado de Vida",
        cost: 50000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      ...
      "A muralha pode ser destruída, também, uma camada por vez, em ordem de vermelho à violeta, pelos meios especificados em cada camada. Quando uma camada é destruída, ela permanece assim pela duração da magia. Um bastão do cancelamento destrói uma muralha prismática, mas um campo antimagia não produz efeito nela.",
      {
        ...
        name: "Vermelho",
        entries: [
          "O alvo sofre {@dice 10d6} de dano de fogo se falhar na resistência ou metade desse dano se obtiver sucesso. Enquanto essa camada estiver no lugar, ataques à distância não-mágicos não podem atravessar a muralha. A camada pode ser destruída causando, pelo menos, 25 de dano de frio a ela.",
        ],
      },
      {
        type: "entries",
        name: "Laranja",
        entries: [
          "O alvo sofre {@dice 10d6} de dano de ácido se falhar na resistência ou metade desse dano se obtiver sucesso. Enquanto essa camada estiver no lugar, ataques à distância mágicos não podem atravessar a muralha. A camada pode ser destruída por um vento forte.",
        ],
      },
      {
        type: "entries",
        name: "Amarelo",
        entries: [
          "O alvo sofre {@dice 10d6} de dano elétrico se falhar na resistência ou metade desse dano se obtiver sucesso. A camada pode ser destruída causando, pelo menos, 60 de dano de energia a ela.",
        ],
      },
      {
        type: "entries",
        name: "Verde",
        entries: [
          "O alvo sofre {@dice 10d6} de dano de veneno se falhar na resistência ou metade desse dano se obtiver sucesso. A magia criar passagem ou outra magia de nível igual ou superior que possam abrir um portal em uma superfície sólida, destroem essa camada.",
        ],
      },
      {
        type: "entries",
        name: "Azul",
        entries: [
          "O alvo sofre {@dice 10d6} de dano de frio se falhar na resistência ou metade desse dano se obtiver sucesso. A camada pode ser destruída causando, pelo menos, 25 de dano de fogo a ela.",
        ],
      },
      {
        type: "entries",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um diamante valendo, no mínimo, 5.000 po",
        cost: 500000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        name: "Rodada 3",
        entries: [
          "Você convoca seis relâmpagos da nuvem para atingir seis criaturas ou objetos, à sua escolha, abaixo da nuvem. Uma mesma criatura ou objeto não pode ser atingido por mais de um raio. Uma criatura atingida deve realizar um teste de resistência de Destreza. A criatura sofrerá {@dice 10d6} de dano elétrico se falhar na resistência ou metade desse dano se passar.",
        ],
      },
      {
        type: "entries",
        name: "Rodada 4",
        entries: [
          "Granizo chove da nuvem. Cada criatura abaixo da nuvem sofre {@dice 2d6} de dano de concussão.",
        ],
      },
      {
        type: "entries",
  ...
  },
  {
    ...
    entries: [
      ...
      "O estresse da conjuração dessa magia para produzir qualquer efeito diferente de copiar outra magia enfraquece você. Após enfrentar esse estresse, a cada vez que você conjurar uma magia, antes de terminar um descanso longo, você sofrerá {@dice 1d10} de dano necrótico por nível da magia. Esse dano não pode ser reduzido ou prevenido de forma alguma. Além disso, sua Força cai para 3, se ela já não for 3 ou inferior, por {@dice 2d4} dias. Para cada dia desses que você permanecer descansando e não fizer nada além de atividades leves, seu tempo de recuperação é reduzido em 2 dias. Finalmente, existe 33 por cento de chance de você se tornar incapaz de conjurar desejo novamente se você sofrer esse estresse.",
    ],
    damageResist: [
      "acid",
      "bludgeoning",
  ...
  },
  {
    ...
    entries: [
      "Esferas de fogo incandescentes atingem o solo em quatro pontos diferentes que você possa ver, dentro do alcance. Cada criatura numa esfera de 12 metros de raio, centrada em cada ponto escolhido por você, deve realizar um teste de resistência de Destreza. A esfera se espalha, dobrando esquinas. Uma criatura sofre {@dice 20d6} de dano de fogo e {@dice 20d6} de dano de concussão se falhar na resistência ou metade desse dano se obtiver sucesso. Uma criatura na área de mais de uma explosão de chamas é afetada apenas uma vez.",
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "para cada criatura que você afetar com essa magia, você deve fornecer um jacinto valendo, no mínimo, 1.000 po e uma barra de prata com ornamentos esculpidos valendo, no mínimo, 100 po, todos consumidos pela magia",
        consumed: true,
        cost: 110000,
      },
    },
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "um borrifo de água benta e diamantes valendo, no mínimo, 25.000 po, consumidos pela magia",
        consumed: true,
        cost: 2500000,
      },
    },
  ...
  },
  {
    ...
    components: {
      ...
      s: true,
      m: {
        text: "uma argola de jade valendo, no mínimo, 1.500 po, que você deve colocar na sua cabeça antes de conjurar a magia",
        cost: 150000,
      },
    },
    duration: [
  ...
  },
  {
    ...
    entries: [
      "Você, por um breve momento, para o fluxo do tempo pra tudo, menos pra você. Nenhum tempo se passa para as outras criaturas, enquanto você realiza {@dice 1d4 + 1} turnos de uma vez, durante os quais você pode usar ações e se mover normalmente.",
